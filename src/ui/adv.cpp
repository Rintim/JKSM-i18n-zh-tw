        ...
        case 2:
            {
                switch(advPrev)
                {
                    case 0:
                        {
                            ...
                            if(saveMenu.getSelected() > 1 && !(newName = util::toUtf16(util::getString("新名字", false))).empty())
                            {
                    ...
                    case 1:
                        {
                            std::u16string newName;
                            if(sdMenu.getSelected() > 1 && !(newName = util::toUtf16(util::getString("新名字", false))).empty())
                            {
